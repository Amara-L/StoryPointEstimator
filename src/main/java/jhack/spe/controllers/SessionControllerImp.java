...
public class SessionControllerImp implements SessionController {
    ...
    public String openSession(HttpSession session, Model model, @PathVariable("sessionId") String sessionId) {
    ...
    @Override
    public String sendEstimate(HttpSession session, Model model, @PathVariable String sessionId, Integer estimate) {
        ...
        if (session.getAttribute("userId") != null) {
            ...
            if ((sessionEntity.getOwnerId().equals(userId))
                ...
                sessionService.saveEstimate(userId, estimate);
    ...
    @Override
    public String openControlSessionPage(HttpSession session, Model model, @PathVariable String sessionId) {
    ...
    @Override
    public String addMember(HttpSession session, Model model, @PathVariable String sessionId, String mail) {
        ...
        if (session.getAttribute("userId") != null) {
            ...
            if (sessionEntity.getOwnerId().equals(Integer.parseInt(session.getAttribute("userId").toString()))) {
                ...
                sessionService.inviteMember(Integer.parseInt(sessionId), mail);
    ...
    @Override
    public String closeSession(HttpSession session, Model model, @PathVariable String sessionId) {
    ...
    public String getCreateSession(HttpSession session, Model model) {
        ...
        if (session.getAttribute("userId") != null) {
            ...
            List<StoryPoint> storyPointList =
                    storyPointService.getStoryPointsUser(
                    Integer.parseInt(session.getAttribute("userId").toString()));

            StringBuilder stringBuilder = new StringBuilder("");

                    for (StoryPoint storyPoint : storyPointList) {
    ...
    @Override
    public String postCreateSession(HttpSession session, Model model, String storyPointId) {
